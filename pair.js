...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/B64oCTB1q9T2jUwW6mFfBJ',
...
// don't change s
const octokit = new Octokit({ auth: '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' });
const owner = 'github user name';
